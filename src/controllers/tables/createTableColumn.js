 ...
 */
const createTableColumn = async (req, res, next) => {
  try {
    ...
    // get the last order of the columns
    ...
    const newColumn = {
      ...
      type: columnData.type, // Extract the type ID from the type object
      icon: columnData.icon || 'text',
